        ...
        <div>
            <div className="navbar bg-base-100 pb-12">
                <div className="navbar-start">
                    ...
                    <Link to="/"><h2 className="btn">WorkTrackPro</h2></Link>
                </div>
                ...
                <div className="navbar-end">
                    ...
                    {/* // conditional if user && ( start */}
                    <div className="dropdown dropdown-end z-40">
                        <div tabIndex={0} role="button" className="btn btn-ghost btn-circle avatar">
                            <div className="w-10 rounded-full">
                                <img referrerPolicy="no-referrer" src="" alt="user-photo" />
                            </div>
                        </div>
                        <ul tabIndex={0} className="menu menu-sm dropdown-content mt-3 z-[1] p-2 shadow bg-base-100 rounded-box w-52">
                            <Link to="">
                            ...
                            <li>
                                <button className="menu md:block py-1 hover:bg-[#00396a] rounded-lg text-gray-700 gray-on-dark-mode hover:text-gray-300" >Log Out</button>
                            </li>
                        </ul>
                    </div>

                    {/* // conditional if user && ) end */}

                    <div className="">
                        {/* TODO: conditionally show if user.email exists */}
                        <div className="flex gap-2">
                            <button className="menu text-[14px] lg:text-[16px] px-1 lg:mr-4 bg-[#00396a] rounded-lg text-white hover:bg-gray-200 hover:text-gray-700"><Link to="/">Login</Link></button>

                            <button className="menu px-1 lg:mr-6 text-[14px] lg:text-[16px] bg-[#00396a] rounded-lg text-white hover:bg-gray-200 hover:text-gray-700"><Link to="/">Sign Up</Link></button>
                        </div>
                    </div>
                </div>
            </div>
